...
$queryString = "select * from tbl_staff";
...
$queryStringDis = "select * from tbl_staff limit 5";
                                ...
                                <table class="table table-bordered table-hover table-responsive">
                                    ...
                                    <?php foreach($resultSet as $row):?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#staffModal" onclick="preEdit(this);"><span class="fa fa-pencil"></span></button>&nbsp;&nbsp;
                                                <a onclick="del(this);"><button type="button" class="btn btn-danger"><span class="fa fa-trash"></span></button></a>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>
                                    </tbody>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nhập năm sinh" id="dob" name="dob">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nhập trình độ" id="level" name="level">
                                </div>
                                <div class="form-group">
                                    <label>Chức vụ:</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="idModal" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label>Họ tên:</label>
                                        <input type="text" class="form-control" placeholder="Nhập họ tên" id="nameModal">
                                    </div>
                                    <div class="form-group">
                                        <label>Năm sinh:</label>
                                        <input type="text" class="form-control" placeholder="Nhập năm sinh" id="dobModal">
                                    </div>
                                    <div class="form-group">
                                        <label>Số điện thoại:</label>
                                        <input type="text" class="form-control" placeholder="Nhập số điện thoại" id="phoneModal">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Ảnh</label>
                                        <input type="file" class="form-control" id="imgModal">
                                    </div>
                                    <div class="form-group">
                                        <label>Chức vụ:</label>
                                        <select class="form-control" id="positionModal">
                                            <?php foreach ($resultSet as $row): ?>
                                                <option value="<?php echo $row['name']; ?>"><?php echo $row['name'];?></option>
                                    ...
                                    <div class="form-group">
                                        <label>Trình độ</label>
                                        <input type="text" class="form-control" id="levelModal">
                                    </div>
...
$(document).ready(function(){
  ...
  $("#insertButton").on('click',function (){
        ...
        console.log(img);
        $.ajax({
            url: "http://localhost/staffmanagement/dao/staffDAO.php?action=insert",
            method: "POST",
...
function del(e) {
    ...
    if (confirm == true) {
        ...
        console.log(id);
        $.ajax({
            url: "http://localhost/staffmanagement/dao/staffDAO.php?action=delete",
            method: "POST",
            data: {id:id},
            dataType: "json",
            success: function (data) {
...
function edit(e) {
    ...
    console.log(idFirst);
    $.ajax({
        url: "http://localhost/staffmanagement/dao/staffDAO.php?action=edit",
        method: "POST",
...
function pagination(p) {
    ...
    $.ajax({
        url: "http://localhost/staffmanagement/util/paginationStaffUtil.php?page=".concat(p),
        method: "GET",
        success: function (data) {
            $("#tableBody").html(data);
